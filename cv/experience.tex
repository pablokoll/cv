...
% \vspace{3.5mm}
\cventry
    {IT Technical Specialist \& Backend Developer} % Job title
    {Tendam} % Organization
    {Madrid, Spain} % Location
    {Dec. 2024 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Built and integrated payment gateway processing logic with Adyen, Redsys, and Cybersource, handling multi-country payment validation, transaction processing, and error handling.}
        \item {Implemented billing systems compliant with tax regulations and invoicing requirements for multiple countries, ensuring legal compliance across different jurisdictions.}
        \item {Developed core functionalities for order management, returns, and exchanges workflows, streamlining customer service operations across international markets.}
        \item {Developing backend features using Salesforce Commerce Cloud (SFCC) for TENDAM's eCommerce platform that serves millions of customers across multiple countries and processes 10,000+ daily orders.}
        \item {Participated in the implementation and integration of a new Order Management System (OMS) with the existing SFCC ecosystem.}
        \item {Collaborated within an Agile team using Jira for sprint planning and task management, maintaining technical and functional documentation in Confluence.}
      \end{cvitems}
    }
  \vspace{5.5mm}
%---------------------------------------------------------
\cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Full Stack development in Shopify using various themes based on Liquid, HTML, CSS, and JavaScript.}
...
%---------------------------------------------------------
\cventry
    {Software Developer \& Backend Developer} % Job title
    ...
    {Jul. 2022 - Jul. 2024} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Participating in the backend team for developing and maintaining software to synchronize Abbott's multi-instance Magento eCommerce with its Salesforce CRM.}
        \item {Integrating the eCommerce system with the ERPs and carriers of Abbott's eight main countries in Latin America.}
        \item {Creating and maintaining middleware in NestJS, implementing functionalities for the eCommerce platforms of multiple clients.}
        ...
        \item {Utilizing project management tools like Jira and Confluence.}
      \end{cvitems}
    }
  \vspace{5.5mm}
%---------------------------------------------------------
